...
7. Use **Download** in the 12-week progress card to create a formatted, single-sheet `.xlsx` file generated by the app. It contains vehicle details, first/last trip odometers, summary totals and percentages, and all trip rows.
